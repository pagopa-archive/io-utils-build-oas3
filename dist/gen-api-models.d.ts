...
export declare function renderOperation(method: string, operationId: string, operation: OpenAPIV2.OperationObject, specParameters: OpenAPIV2.ParametersDefinitionsObject | undefined, securityDefinitions: OpenAPIV2.Document["securityDefinitions"], extraHeaders: ReadonlyArray<string>, extraParameters: {
    [key: string]: string;
